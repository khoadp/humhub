...
$primaryColor = '#708fa0';
if(Setting::Get('primaryColor') != null){
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <label class="control-label" for="default_color"><?= Yii::t('AdminModule.views_setting_index', "Primary Color") ?></label>
            <div class="input-group space-color-chooser-edit">
                <?= Html::textInput('primaryColor', $primaryColor, ['class' => 'form-control', 'id' => 'space-color-picker-edit']); ?>
