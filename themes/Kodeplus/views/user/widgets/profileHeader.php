                ...
                <div class="col-md-12">
                    <div class="statistics pull-left">
                        ...
                        <?php if ($friendshipsEnabled): ?>
                            <a href="<?= Url::to(['/friendship/list/popup', 'userId' => $user->id]); ?>"
                        ...
                        <a href="<?= $user->createUrl('/user/profile/followed-users-list'); ?>"
                                data-target="#globalModal">
                            <div class="pull-left entry">
                        ...
                        <a href="<?= $user->createUrl('/user/profile/space-membership-list'); ?>"
                                data-target="#globalModal">
                            <div class="pull-left entry">
                        ...
                        <?php if (isset($user->profile->score)) { ?>
                            <a href="javascript:void(0)">
                                <div class="pull-left entry">
                                    <span class="count"><?php echo $user->profile->score; ?></span><br>
                                    <span class="title"><?php echo Yii::t('UserModule.widgets_views_profileHeader', 'Score'); ?></span>
                                </div>
                            </a>
                        <?php } ?>
                    </div>
