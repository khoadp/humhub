...
$this->registerJsVar('primaryColor', $primaryColor);
$this->registerJsVar('infoColor', $infoColor);
?>
<?php $this->beginPage() ?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <div id="topbar-first" class="topbar">
        <div class="container">
            ...
            <div class="topbar-actions pull-right" style="line-height:3.6em">
                <?php echo \kodeplus\widgets\Language::widget(); ?>
            </div>
    ...
    <?php echo $this->render('responsive'); ?>
